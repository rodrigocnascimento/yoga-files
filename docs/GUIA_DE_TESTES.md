...
# Verifica o diagnóstico completo com relatório
yoga-doctor --report
```
...
# Gerencia plugins ASDF
yoga-plugin list
yoga-plugin install <name> <url>

# Verifica versões instaladas via ASDF
asdf list nodejs
asdf current
```
...
# Remove/desinstala um runtime ASDF completamente (plugin + versões + .tool-versions)
yoga-remove nodejs
...
4. Use a IA para gerar um código: `yoga-ai code "crie um arquivo server.ts rodando express na porta 3000"`
